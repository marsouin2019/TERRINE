...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" media="only screen and (orientation:portrait) and (min-width : 480)" href="accueil.css">
    <link rel="stylesheet" media="only screen and (orientation:portrait) and (min-width : 768)" href="accueil.css">
